...
class CarliniWagnerLIAttack(Attack):
    ...
    def __call__(self, input_or_adv, label=None, unpack=True,
        ...
        for binary_search_step in range(binary_search_steps):
            ...
            logging.info('starting optimization with const = {}, best overall distance = {}'.format(const, a.distance))
    ...
    def loss_function(cls, const, tau, a, x, logits, reconstructed_original,
        ...
        linf_distance_grad = np.sign(x - reconstructed_original)*(np.abs(x - reconstructed_original) - tau > 0)
