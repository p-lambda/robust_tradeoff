...
from models.wideresnet_pre import WideResNetPre
...
def load_tinyimage_subset(version_string='v7'):
    other_data_path = os.path.join(os.path.dirname(__file__), '../data/')
...
def load_cifar10_keywords(unique_keywords=True, 
