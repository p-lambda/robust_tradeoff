########################################
# FROM https://raw.githubusercontent.com/MadryLab/spatial-pytorch/master/robustness/spatial.py
########################################
import torch as ch
...
def transform(x, rots, txs):
    ...
    with ch.no_grad():
        ...
        new_image = ch.nn.functional.grid_sample(x, new_coords, align_corners=True)
        return new_image
